{{> directanswercards/card_component componentName = 'directanswer' }}

class directanswerComponent extends BaseDirectAnswerCard['directanswer'] {
  ...
  static defaultTemplateName (config) {
    return 'directanswercards/directanswer';
  }
}

ANSWERS.registerTemplate(
  'directanswercards/directanswer',
  {{{stringifyPartial (read 'directanswercards/directanswer/template') }}}
);
ANSWERS.registerComponentType(directanswerComponent);
